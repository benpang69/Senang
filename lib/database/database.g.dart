...
class $BoothsTable extends Booths with TableInfo<$BoothsTable, Booth> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $BoothsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'booths';
  @override
  VerificationContext validateIntegrity(
    Insertable<Booth> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Booth map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return Booth(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  $BoothsTable createAlias(String alias) {
    return $BoothsTable(attachedDatabase, alias);
  }
}

class Booth extends DataClass implements Insertable<Booth> {
  final int id;
  final int accountId;
  final String name;
  ...
  BoothsCompanion toCompanion(bool nullToAbsent) {
    return BoothsCompanion(
      id: Value(id),
      accountId: Value(accountId),
      name: Value(name),
  ...
  Booth copyWithCompanion(BoothsCompanion data) {
    return Booth(
      id: data.id.present ? data.id.value : this.id,
      accountId: data.accountId.present ? data.accountId.value : this.accountId,
      name: data.name.present ? data.name.value : this.name,
...
class BoothsCompanion extends UpdateCompanion<Booth> {
  final Value<int> id;
  final Value<int> accountId;
  final Value<String> name;
  ...
  BoothsCompanion.insert({
    ...
    required DateTime updatedAt,
       ...
       createdAt = Value(createdAt),
       updatedAt = Value(updatedAt);
  static Insertable<Booth> custom({
    Expression<int>? id,
    Expression<int>? accountId,
    Expression<String>? name,
  ...
  @override
  String toString() {
    return (StringBuffer('BoothsCompanion(')
          ..write('id: $id, ')
          ..write('accountId: $accountId, ')
          ..write('name: $name, ')
          ..write('description: $description, ')
...
class $CategoriesTable extends Categories
  ...
  static const VerificationMeta _boothIdMeta = const VerificationMeta(
    'boothId',
  );
  @override
  late final GeneratedColumn<int> boothId = GeneratedColumn<int>(
    'booth_id',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('booth_id')) {
      context.handle(
        _boothIdMeta,
        boothId.isAcceptableOrUnknown(data['booth_id']!, _boothIdMeta),
      );
    } else if (isInserting) {
      context.missing(_boothIdMeta);
    }
    if (data.containsKey('name')) {
      context.handle(
        _nameMeta,
  ...
  Category map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Category(
      ...
      boothId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}booth_id'],
      )!,
      name: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}name'],
...
class Category extends DataClass implements Insertable<Category> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    map['booth_id'] = Variable<int>(boothId);
    map['name'] = Variable<String>(name);
    if (!nullToAbsent || description != null) {
      map['description'] = Variable<String>(description);
    }
  ...
  factory Category.fromJson(
    ...
    return Category(
      id: serializer.fromJson<int>(json['id']),
      boothId: serializer.fromJson<int>(json['boothId']),
      name: serializer.fromJson<String>(json['name']),
      description: serializer.fromJson<String?>(json['description']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'boothId': serializer.toJson<int>(boothId),
      'name': serializer.toJson<String>(name),
      'description': serializer.toJson<String?>(description),
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
  ...
  Category copyWithCompanion(CategoriesCompanion data) {
    return Category(
      id: data.id.present ? data.id.value : this.id,
      boothId: data.boothId.present ? data.boothId.value : this.boothId,
      name: data.name.present ? data.name.value : this.name,
      description: data.description.present
          ? data.description.value
          : this.description,
  ...
  @override
  int get hashCode =>
      Object.hash(id, boothId, name, description, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Category &&
          other.id == this.id &&
          other.boothId == this.boothId &&
          other.name == this.name &&
          other.description == this.description &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt);
...
class CategoriesCompanion extends UpdateCompanion<Category> {
  ...
  const CategoriesCompanion({
    this.id = const Value.absent(),
    this.boothId = const Value.absent(),
    this.name = const Value.absent(),
    this.description = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (boothId.present) {
      map['booth_id'] = Variable<int>(boothId.value);
    }
    if (name.present) {
      map['name'] = Variable<String>(name.value);
    }
...
class $ProductCustomValuesTable extends ProductCustomValues
    with TableInfo<$ProductCustomValuesTable, ProductCustomValue> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ProductCustomValuesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  List<GeneratedColumn> get $columns => [id, productId, customFieldId, value];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'product_custom_values';
  @override
  VerificationContext validateIntegrity(
    Insertable<ProductCustomValue> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ProductCustomValue map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ProductCustomValue(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $ProductCustomValuesTable createAlias(String alias) {
    return $ProductCustomValuesTable(attachedDatabase, alias);
  }
}

class ProductCustomValue extends DataClass
    implements Insertable<ProductCustomValue> {
  final int id;
  final int productId;
  ...
  ProductCustomValuesCompanion toCompanion(bool nullToAbsent) {
    return ProductCustomValuesCompanion(
      id: Value(id),
  ...
  factory ProductCustomValue.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ProductCustomValue copyWithCompanion(ProductCustomValuesCompanion data) {
    return ProductCustomValue(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('ProductCustomValue(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode => Object.hash(id, productId, customFieldId, value);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProductCustomValue &&
          other.id == this.id &&
...
class ProductCustomValuesCompanion extends UpdateCompanion<ProductCustomValue> {
  final Value<int> id;
  final Value<int> productId;
  final Value<int> customFieldId;
  final Value<String> value;
  const ProductCustomValuesCompanion({
    this.id = const Value.absent(),
    this.productId = const Value.absent(),
    this.customFieldId = const Value.absent(),
    this.value = const Value.absent(),
  });
  ProductCustomValuesCompanion.insert({
    this.id = const Value.absent(),
    ...
    required String value,
       ...
       customFieldId = Value(customFieldId),
       value = Value(value);
  static Insertable<ProductCustomValue> custom({
    Expression<int>? id,
  ...
  ProductCustomValuesCompanion copyWith({
    Value<int>? id,
    Value<int>? productId,
  ...
  @override
  String toString() {
    return (StringBuffer('ProductCustomValuesCompanion(')
          ..write('id: $id, ')
          ..write('productId: $productId, ')
          ..write('customFieldId: $customFieldId, ')
          ..write('value: $value')
...
class $DailyClosingsTable extends DailyClosings
  ...
  @override
  late final GeneratedColumn<int> cashExpenses = GeneratedColumn<int>(
    'cash_expenses',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class DailyClosing extends DataClass implements Insertable<DailyClosing> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['cash_expenses'] = Variable<int>(cashExpenses);
  ...
  factory DailyClosing.fromJson(
    ...
    return DailyClosing(
      ...
      cashExpenses: serializer.fromJson<int>(json['cashExpenses']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'cashExpenses': serializer.toJson<int>(cashExpenses),
...
class DailyClosingsCompanion extends UpdateCompanion<DailyClosing> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (cashExpenses.present) {
      map['cash_expenses'] = Variable<int>(cashExpenses.value);
    }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $BoothsTable booths = $BoothsTable(this);
  late final $CategoriesTable categories = $CategoriesTable(this);
  late final $ProductsTable products = $ProductsTable(this);
  late final $CustomFieldsTable customFields = $CustomFieldsTable(this);
  late final $ProductCustomValuesTable productCustomValues =
      $ProductCustomValuesTable(this);
...
final class $$AccountsTableReferences
  ...
  static MultiTypedResultKey<$UsersTable, List<User>> _usersRefsTable(
    ...
    db.users,
    aliasName: 'accounts__id__users__account_id',
  );
  ...
  static MultiTypedResultKey<$BoothsTable, List<Booth>> _boothsRefsTable(
    _$AppDatabase db,
  ) => MultiTypedResultKey.fromTable(
    db.booths,
    aliasName: 'accounts__id__booths__account_id',
  );

  $$BoothsTableProcessedTableManager get boothsRefs {
    final manager = $$BoothsTableTableManager(
      $_db,
      $_db.booths,
    ).filter((f) => f.accountId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_boothsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$AccountsTableFilterComposer
  ...
  Expression<bool> boothsRefs(
    Expression<bool> Function($$BoothsTableFilterComposer f) f,
  ) {
    final $$BoothsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.booths,
      getReferencedColumn: (t) => t.accountId,
      builder:
          (
            joinBuilder, {
...
class $$AccountsTableAnnotationComposer
  ...
  Expression<T> boothsRefs<T extends Object>(
    Expression<T> Function($$BoothsTableAnnotationComposer a) f,
  ) {
    final $$BoothsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.booths,
      getReferencedColumn: (t) => t.accountId,
...
class $$AccountsTableTableManager
    extends
        RootTableManager<
          ...
          Account,
          PrefetchHooks Function({bool usersRefs, bool boothsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({usersRefs = false, boothsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (usersRefs) db.users,
                if (boothsRefs) db.booths,
              ],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  if (usersRefs)
                    await $_getPrefetchedData<Account, $AccountsTable, User>(
                      currentTable: table,
                      referencedTable: $$AccountsTableReferences
                          ._usersRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $$AccountsTableReferences(db, table, p0).usersRefs,
                      referencedItemsForCurrentItem: (item, referencedItems) =>
                          referencedItems.where((e) => e.accountId == item.id),
                      typedResults: items,
                    ),
                  if (boothsRefs)
                    await $_getPrefetchedData<Account, $AccountsTable, Booth>(
                      currentTable: table,
                      referencedTable: $$AccountsTableReferences
                          ._boothsRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $$AccountsTableReferences(db, table, p0).boothsRefs,
                      referencedItemsForCurrentItem: (item, referencedItems) =>
                          referencedItems.where((e) => e.accountId == item.id),
                      typedResults: items,
                    ),
...
final class $$UsersTableReferences
  ...
  static $AccountsTable _accountIdTable(_$AppDatabase db) =>
      db.accounts.createAlias('users__account_id__accounts__id');
  ...
  _dailyClosingsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.dailyClosings,
    aliasName: 'users__id__daily_closings__closed_by_user_id',
  );
...
typedef $$UsersTableProcessedTableManager =
    ...
    >;
typedef $$BoothsTableCreateCompanionBuilder = BoothsCompanion Function({
  Value<int> id,
  required int accountId,
  required String name,
  Value<String?> description,
...
typedef $$BoothsTableUpdateCompanionBuilder = BoothsCompanion Function({
  Value<int> id,
  Value<int> accountId,
  Value<String> name,
  Value<String?> description,
...
final class $$BoothsTableReferences
    extends BaseReferences<_$AppDatabase, $BoothsTable, Booth> {
  $$BoothsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $AccountsTable _accountIdTable(_$AppDatabase db) =>
      db.accounts.createAlias('booths__account_id__accounts__id');
  ...
  _categoriesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.categories,
    aliasName: 'booths__id__categories__booth_id',
  );
  ...
  $$CategoriesTableProcessedTableManager get categoriesRefs {
    final manager = $$CategoriesTableTableManager(
      $_db,
      $_db.categories,
    ).filter((f) => f.boothId.id.sqlEquals($_itemColumn<int>('id')!));
  ...
  static MultiTypedResultKey<$ProductsTable, List<Product>> _productsRefsTable(
    ...
    db.products,
    aliasName: 'booths__id__products__booth_id',
  );
  ...
  _customFieldsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.customFields,
    aliasName: 'booths__id__custom_fields__booth_id',
  );
  ...
  static MultiTypedResultKey<$SalesTable, List<Sale>> _salesRefsTable(
    ...
    db.sales,
    aliasName: 'booths__id__sales__booth_id',
  );
  ...
  _stockMovementsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.stockMovements,
    aliasName: 'booths__id__stock_movements__booth_id',
  );
  ...
  static MultiTypedResultKey<$ExpensesTable, List<Expense>> _expensesRefsTable(
    ...
    db.expenses,
    aliasName: 'booths__id__expenses__booth_id',
  );
  ...
  _dailyClosingsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.dailyClosings,
    aliasName: 'booths__id__daily_closings__booth_id',
  );
...
class $$BoothsTableFilterComposer
    extends Composer<_$AppDatabase, $BoothsTable> {
  $$BoothsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  Expression<bool> categoriesRefs(
    ...
    final $$CategoriesTableFilterComposer composer = $composerBuilder(
      ...
      getReferencedColumn: (t) => t.boothId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
...
class $$BoothsTableOrderingComposer
    extends Composer<_$AppDatabase, $BoothsTable> {
  $$BoothsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$BoothsTableAnnotationComposer
    extends Composer<_$AppDatabase, $BoothsTable> {
  $$BoothsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$BoothsTableTableManager
    extends
        RootTableManager<
          ...
          $$BoothsTableOrderingComposer,
          $$BoothsTableAnnotationComposer,
          $$BoothsTableCreateCompanionBuilder,
          $$BoothsTableUpdateCompanionBuilder,
          (Booth, $$BoothsTableReferences),
          Booth,
          PrefetchHooks Function({
            bool accountId,
            bool categoriesRefs,
        ...
        > {
  $$BoothsTableTableManager(_$AppDatabase db, $BoothsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$BoothsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$BoothsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$BoothsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<int> accountId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$BoothsTable, Booth>(table),
                  $$BoothsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
                ...
                return PrefetchHooks(
                      ...
                      >(state) {
                        if (accountId) {
                          state = state.withJoin(
                            currentTable: table,
                            currentColumn: table.accountId,
                            referencedTable: $$BoothsTableReferences
                                ._accountIdTable(db),
                            referencedColumn: $$BoothsTableReferences
                                ._accountIdTable(db)
                                .id,
                          ) as T;
                        }
                  ...
                  getPrefetchedDataCallback: (items) async {
                    return [
                      ...
                      if (productsRefs)
                        await $_getPrefetchedData<Booth, $BoothsTable, Product>(
                          currentTable: table,
                          referencedTable: $$BoothsTableReferences
                      ...
                      if (salesRefs)
                        await $_getPrefetchedData<Booth, $BoothsTable, Sale>(
                          currentTable: table,
                          referencedTable: $$BoothsTableReferences
                              ._salesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$BoothsTableReferences(db, table, p0).salesRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.boothId == item.id,
                              ),
                      ...
                      if (expensesRefs)
                        await $_getPrefetchedData<Booth, $BoothsTable, Expense>(
                          currentTable: table,
                          referencedTable: $$BoothsTableReferences
                              ._expensesRefsTable(db),
                          managerFromTypedResult: (p0) =>
...
typedef $$BoothsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $BoothsTable,
      Booth,
...
final class $$CategoriesTableReferences
  ...
  static $BoothsTable _boothIdTable(_$AppDatabase db) =>
      db.booths.createAlias('categories__booth_id__booths__id');

  $$BoothsTableProcessedTableManager get boothId {
    final $_column = $_itemColumn<int>('booth_id')!;

    final manager = $$BoothsTableTableManager(
      $_db,
      $_db.booths,
    ).filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_boothIdTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
    );
...
class $$CategoriesTableFilterComposer
  ...
  $$BoothsTableFilterComposer get boothId {
    final $$BoothsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.boothId,
      referencedTable: $db.booths,
      getReferencedColumn: (t) => t.id,
      builder:
          (
...
class $$CategoriesTableOrderingComposer
  ...
  $$BoothsTableOrderingComposer get boothId {
    final $$BoothsTableOrderingComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.boothId,
      referencedTable: $db.booths,
      getReferencedColumn: (t) => t.id,
...
class $$CategoriesTableAnnotationComposer
  ...
  $$BoothsTableAnnotationComposer get boothId {
    final $$BoothsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.boothId,
      referencedTable: $db.booths,
...
class $$CategoriesTableTableManager
    extends
        RootTableManager<
          ...
          Category,
          PrefetchHooks Function({bool boothId, bool productsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<int> boothId = const Value.absent(),
                Value<String> name = const Value.absent(),
                Value<String?> description = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
                Value<DateTime> updatedAt = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({boothId = false, productsRefs = false}) {
            return PrefetchHooks(
              db: db,
...
final class $$ProductsTableReferences
  ...
  static $BoothsTable _boothIdTable(_$AppDatabase db) =>
      db.booths.createAlias('products__booth_id__booths__id');
  ...
  static MultiTypedResultKey<
    $ProductCustomValuesTable,
    List<ProductCustomValue>
  >
  _productCustomValuesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.productCustomValues,
        aliasName: 'products__id__product_custom_values__product_id',
      );

  $$ProductCustomValuesTableProcessedTableManager get productCustomValuesRefs {
    final manager = $$ProductCustomValuesTableTableManager(
      $_db,
      $_db.productCustomValues,
    ).filter((f) => f.productId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _productCustomValuesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$ProductsTableFilterComposer
  ...
  Expression<bool> productCustomValuesRefs(
    Expression<bool> Function($$ProductCustomValuesTableFilterComposer f) f,
  ) {
    final $$ProductCustomValuesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.productCustomValues,
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ProductCustomValuesTableFilterComposer(
            $db: $db,
            $table: $db.productCustomValues,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$ProductsTableAnnotationComposer
  ...
  Expression<T> productCustomValuesRefs<T extends Object>(
    Expression<T> Function($$ProductCustomValuesTableAnnotationComposer a) f,
  ) {
    final $$ProductCustomValuesTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.productCustomValues,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$ProductCustomValuesTableAnnotationComposer(
                $db: $db,
                $table: $db.productCustomValues,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
          ...
          prefetchHooksCallback:
              ({
                ...
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (productCustomValuesRefs) db.productCustomValues,
                    ...
                    return [
                      if (productCustomValuesRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$ProductsTableReferences
                              ._productCustomValuesRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$ProductsTableReferences(
                                db,
                                table,
                                p0,
                              ).productCustomValuesRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
...
final class $$CustomFieldsTableReferences
  ...
  static $BoothsTable _boothIdTable(_$AppDatabase db) =>
      db.booths.createAlias('custom_fields__booth_id__booths__id');
  ...
  _productCustomValuesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.productCustomValues,
        aliasName: 'custom_fields__id__product_custom_values__custom_field_id',
      );
...
class $$CustomFieldsTableTableManager
    extends
        RootTableManager<
          ...
          CustomField,
          PrefetchHooks Function({bool boothId, bool productCustomValuesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$CustomFieldsTable, CustomField>(table),
                  $$CustomFieldsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback:
              ({boothId = false, productCustomValuesRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (productCustomValuesRefs) db.productCustomValues,
...
typedef $$CustomFieldsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool boothId, bool productCustomValuesRefs})
    >;
typedef $$ProductCustomValuesTableCreateCompanionBuilder =
    ProductCustomValuesCompanion Function({
      Value<int> id,
      required int productId,
      required int customFieldId,
      required String value,
    });
typedef $$ProductCustomValuesTableUpdateCompanionBuilder =
    ProductCustomValuesCompanion Function({
      Value<int> id,
      Value<int> productId,
      Value<int> customFieldId,
...
final class $$ProductCustomValuesTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $ProductCustomValuesTable,
          ProductCustomValue
        > {
  $$ProductCustomValuesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $ProductsTable _productIdTable(_$AppDatabase db) => db.products
      .createAlias('product_custom_values__product_id__products__id');
  ...
  static $CustomFieldsTable _customFieldIdTable(_$AppDatabase db) => db
      .customFields
      .createAlias('product_custom_values__custom_field_id__custom_fields__id');
...
class $$ProductCustomValuesTableFilterComposer
    extends Composer<_$AppDatabase, $ProductCustomValuesTable> {
  $$ProductCustomValuesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ProductCustomValuesTableOrderingComposer
    extends Composer<_$AppDatabase, $ProductCustomValuesTable> {
  $$ProductCustomValuesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ProductCustomValuesTableAnnotationComposer
    extends Composer<_$AppDatabase, $ProductCustomValuesTable> {
  $$ProductCustomValuesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$ProductCustomValuesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ProductCustomValuesTable,
          ...
          $$ProductCustomValuesTableOrderingComposer,
          $$ProductCustomValuesTableAnnotationComposer,
          $$ProductCustomValuesTableCreateCompanionBuilder,
          $$ProductCustomValuesTableUpdateCompanionBuilder,
          (ProductCustomValue, $$ProductCustomValuesTableReferences),
          ProductCustomValue,
          PrefetchHooks Function({bool productId, bool customFieldId})
        > {
  $$ProductCustomValuesTableTableManager(
    _$AppDatabase db,
    $ProductCustomValuesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ProductCustomValuesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ProductCustomValuesTableOrderingComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$ProductCustomValuesTable, ProductCustomValue>(
                    table,
                  ),
                  $$ProductCustomValuesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({productId = false, customFieldId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
                  ...
                  >(state) {
                    if (productId) {
                      state = state.withJoin(
                        ...
                        referencedTable: $$ProductCustomValuesTableReferences
                            ._productIdTable(db),
                        referencedColumn: $$ProductCustomValuesTableReferences
                            ._productIdTable(db)
                            .id,
                      ) as T;
                    }
...
typedef $$ProductCustomValuesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ProductCustomValuesTable,
      ProductCustomValue,
...
final class $$SalesTableReferences
  ...
  static $BoothsTable _boothIdTable(_$AppDatabase db) =>
      db.booths.createAlias('sales__booth_id__booths__id');
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({boothId = false, userId = false, saleItemsRefs = false}) {
                return PrefetchHooks(
                  db: db,
...
typedef $$SalesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (Sale, $$SalesTableReferences),
      Sale,
      PrefetchHooks Function({bool boothId, bool userId, bool saleItemsRefs})
    >;
...
final class $$StockMovementsTableReferences
  ...
  static $BoothsTable _boothIdTable(_$AppDatabase db) =>
      db.booths.createAlias('stock_movements__booth_id__booths__id');
...
class $$StockMovementsTableTableManager
    extends
        RootTableManager<
          ...
          StockMovement,
          PrefetchHooks Function({bool boothId, bool productId})
        > {
    ...
    $StockMovementsTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({boothId = false, productId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
final class $$ExpensesTableReferences
  ...
  static $BoothsTable _boothIdTable(_$AppDatabase db) =>
      db.booths.createAlias('expenses__booth_id__booths__id');
...
class $$ExpensesTableTableManager
    extends
        RootTableManager<
          ...
          Expense,
          PrefetchHooks Function({bool boothId, bool userId})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({boothId = false, userId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
final class $$DailyClosingsTableReferences
  ...
  static $BoothsTable _boothIdTable(_$AppDatabase db) =>
      db.booths.createAlias('daily_closings__booth_id__booths__id');
  ...
  static $UsersTable _closedByUserIdTable(_$AppDatabase db) =>
      db.users.createAlias('daily_closings__closed_by_user_id__users__id');
...
class $$DailyClosingsTableFilterComposer
  ...
  ColumnFilters<int> get cashExpenses => $composableBuilder(
...
class $$DailyClosingsTableOrderingComposer
  ...
  ColumnOrderings<int> get cashExpenses => $composableBuilder(
    column: $table.cashExpenses,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$DailyClosingsTableAnnotationComposer
  ...
  GeneratedColumn<int> get cashExpenses => $composableBuilder(
    column: $table.cashExpenses,
    builder: (column) => column,
  );
...
class $$DailyClosingsTableTableManager
    extends
        RootTableManager<
          ...
          DailyClosing,
          PrefetchHooks Function({bool boothId, bool closedByUserId})
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> cashExpenses = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({boothId = false, closedByUserId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
class $AppDatabaseManager {
  ...
  $$BoothsTableTableManager get booths =>
      $$BoothsTableTableManager(_db, _db.booths);
  ...
  $$ProductCustomValuesTableTableManager get productCustomValues =>
      $$ProductCustomValuesTableTableManager(_db, _db.productCustomValues);
